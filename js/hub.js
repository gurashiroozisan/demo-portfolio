...
const PORTFOLIO = [
  ...
  { type: 'tool', tags: ['デスクトップ', 'リネーム', 'ファイル'], title: 'BatchRename 一括リネーム', category: 'デスクトップアプリ', desc: 'プレフィックス・連番・置換ルールでファイル名を一括変更。プレビュー付き。', url: 'rename-demo/index.html', thumb: 'rename-demo/assets/images/preview.png', badge: 'App' },
  { type: 'tool', tags: ['デスクトップ', 'PDF'], title: 'PDF Stitch 結合・分割', category: 'デスクトップアプリ', desc: '複数PDFの結合・ページ分割。並べ替えてワンクリック処理（デモ）。', url: 'pdf-merge-demo/index.html', thumb: 'pdf-merge-demo/assets/images/preview.png', badge: 'App' },
