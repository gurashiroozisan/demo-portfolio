...
const PORTFOLIO = [
  ...
  { type: 'lp', tags: ['士業'], title: '行政書士 田中事務所', category: '士業・専門家', desc: 'ビザ・会社設立・許認可の行政書士向けLP。', url: 'gyosei-lp/index.html', thumb: 'gyosei-lp/assets/images/preview.png', badge: 'LP', case: { challenge: '対応業務が多く何を頼めるか分かりにくい', solution: 'ビザ・許認可など業務別に整理したLP', effect: '依頼内容の明確化で問い合わせ精度向上' } },
  ...
  { type: 'lp', tags: ['イベント'], title: 'Wedding Venue LUCE', category: '結婚式場', desc: 'プラン・ギャラリー・見学予約のウェディング会場LP。', url: 'wedding-lp/index.html', thumb: 'wedding-lp/assets/images/preview.png', badge: 'LP', case: { challenge: '会場の雰囲気が伝わらず見学予約が少ない', solution: 'プラン・ギャラリー付きウェディングLP', effect: '見学予約への動機づけを強化' } },
  { type: 'lp', tags: ['SaaS', 'IT'], title: 'TaskPilot', category: 'SaaS・アプリ', desc: 'プロジェクト管理SaaSのLP。機能・料金プラン・登録CTAで購買導線を設計。', url: 'saas-lp/index.html', thumb: 'saas-lp/assets/images/preview.png', badge: 'LP', case: { challenge: 'SaaSの機能訴求が弱くトライアルに繋がらない', solution: '機能・料金プランを整理したSaaS LP', effect: '無料トライアルへの導線を確保' } },
  ...
  { type: 'hp', tags: ['メディア', 'ブログ'], title: 'Tech & Life', category: 'メディア・ブログ', desc: '記事一覧＋詳細ページのメディアサイト構成。', url: 'media-site/index.html', thumb: 'media-site/assets/images/preview.png', badge: 'HP', case: { challenge: '記事が散在しメディアとしての体裁がない', solution: '一覧＋記事詳細のメディアサイト構成', effect: 'コンテンツの回遊率と滞在時間を向上' } },
];
...
function buildGroups(items) {
  ...
  if (currentFilter === 'lp' || currentFilter === 'hp') return null;
