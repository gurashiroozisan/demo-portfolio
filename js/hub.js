...
const PORTFOLIO = [
  ...
  { type: 'lp', tags: ['SaaS', 'IT'], title: 'TaskPilot', category: 'SaaS・アプリ', desc: 'プロジェクト管理SaaSのLP。機能・料金プラン・登録CTA。', url: 'saas-lp/index.html', thumb: 'saas-lp/assets/images/preview.png', badge: 'LP', case: { challenge: 'SaaSの機能訴求が弱くトライアルに繋がらない', solution: '機能・料金プランを整理したSaaS LP', effect: '無料トライアルへの導線を確保' } },
